  ...
  return (
    <section className='py-16 px-4 lg:px-0'>
        ...
        <div className="container mx-auto text-center mb-10 relative">
            ...
            className={`p-2 rounded-full border ${canScrollLeft ? "bg-white text-black cursor-pointer" : "bg-gray-200 text-gray-400 cursor-not-allowed"} `}>
                <FiChevronLeft className='text-2xl' />
            </button>
            <button
            onClick={() =>scroll("right")}
            className={`p-2 rounded-full border ${canScrollRight ? "bg-white text-black cursor-pointer" : "bg-gray-200 text-gray-400 cursor-not-allowed"} `}>
