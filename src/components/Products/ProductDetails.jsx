                    ...
                    <div className="flex gap-2 mt-2">
                        ...
                        <div className="mb-6 ">
                            ...
                            <div className="flex items-center space-x-4 mt-2">
                                ...
                                className='px-2 py-1 bg-gray-200 cursor-pointer rounded text-lg'>-</button>
                                ...
                                className='px-2 py-1 cursor-pointer bg-gray-200 rounded text-lg'>+</button>
                        ...
                        className={`bg-black text-white py-2 px-6 rounded w-full mb-4 cursor-pointer ${isButtonDisabled ? "cursor-not-allowed opacity-50" : "hover:bg-gray-900"}`}>{isButtonDisabled ?"Adding...":"ADD TO CART"}</button>
