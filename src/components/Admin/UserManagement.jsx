...
const UserManagement = () => {
    ...
    const handleSubmit= (e) =>{
        ...
        // Reject the form after submission
        setFormData({
            name:"",
            email:"",
            password:"",
            ...
            <table className="min-w-full text-left text-gray-500">
                <thead className="bg-gray-100 text-xs uppercase text-gray-700">
                    <tr>
                        ...
                        <th className="py-3 px-4">Actiond</th>
                    </tr>
                </thead>
                <tbody>
                    {users.map((user) =>(
                        <tr key={user._id} className="border-b hover:bg-gray-50">
                            ...
                            <td className="p-4">
                                <button onClick={() => handleDeleteUser(user._id)}  className="bg-red-500 text-white px-4 py2 rounded hover:bg-red-600">Delete</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
